        ...
        <div class="container" >
                <form class="form-horizontal" id="my_form_id" action="<?php get_permalink();?>" role="form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="date" id="dob" name="user_dob" placeholder="Brith Date" class="form-control" min ="1965-12-31" max="1998-12-31" value="<?php if(isset($_GET['id'])){echo $record['user_dob']; } ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6 col-sm-offset-3">
                            ...
                            {
                                echo "
                                    <button  type='submit'  name='update-form' id='user_add'  onclick='updateForm()'  class='btn btn-primary btn-block'>Update</button>
                                ";
                            }
                            else
                            {
